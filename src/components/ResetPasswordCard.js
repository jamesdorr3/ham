  ...
  render(){
    return(
      ...
      <form onSubmit={this.handleSubmit} className='signupForm'>
        <li>
        <input value={this.props.token} name='token' onChange={this.handleChange} type='text' placeholder='username' />
        </li>
        <li>
          <label>Email</label><br/>
          <input required value={this.props.email} name='email' onChange={this.handleChange} type='email' placeholder='email' />
        </li>
        <li>
